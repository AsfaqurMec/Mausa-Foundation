...
const Footer = () => {
    return (
        <div className="bg-[#22262F] px-4">
       
        <footer className="footer p-10 mt-6  text-base-content">
          <aside >
            <div className="flex gap-4 text-[#EEEEEE]">
        ...
        <div className="mt-6 border-[#454545] border-t-[1px] text-center py-7">
            <h1 className="font-normal text-sm text-[#888888]">স্বত্ব © 2024 মাউসা ফাউন্ডেশন - সর্ব স্বত্ব সংরক্ষিত।</h1>
          </div>
        </div>
    );
};
