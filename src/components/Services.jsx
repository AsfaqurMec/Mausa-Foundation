...
const Services = () => {
    return (
        ...
        <div className=' pb-12'>
            ...
            <div className='card rounded-sm bg-cover bg-base-100'>
...
<div className="card rounded-sm bg-base-100 ">
  <figure><Image className="border mt-8 text-black p-5 w-28 z-10 bg-[#49C70D] rounded-full" src={img2} alt=""></Image></figure>
  <div className="card-body">
